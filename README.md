...
* [Single dependency](https://pkg.go.dev/github.com/seanpfeifer/websocket?tab=imports)
* JSON and protobuf helpers in the [wsjson](https://pkg.go.dev/github.com/seanpfeifer/websocket/wsjson) and [wspb](https://pkg.go.dev/github.com/seanpfeifer/websocket/wspb) subpackages
* Zero alloc reads and writes
* Concurrent writes
* [Close handshake](https://pkg.go.dev/github.com/seanpfeifer/websocket#Conn.Close)
* [net.Conn](https://pkg.go.dev/github.com/seanpfeifer/websocket#NetConn) wrapper
* [Ping pong](https://pkg.go.dev/github.com/seanpfeifer/websocket#Conn.Ping) API
* [RFC 7692](https://tools.ietf.org/html/rfc7692) permessage-deflate compression
* Compile to [Wasm](https://pkg.go.dev/github.com/seanpfeifer/websocket#hdr-Wasm)
...
* Minimal and idiomatic API
  * Compare godoc of [github.com/seanpfeifer/websocket](https://pkg.go.dev/github.com/seanpfeifer/websocket) with [gorilla/websocket](https://pkg.go.dev/github.com/gorilla/websocket) side by side.
* [net.Conn](https://pkg.go.dev/github.com/seanpfeifer/websocket#NetConn) wrapper
...
* Idiomatic [ping pong](https://pkg.go.dev/github.com/seanpfeifer/websocket#Conn.Ping) API
  * Gorilla requires registering a pong callback before sending a Ping
* Can target Wasm ([gorilla/websocket#432](https://github.com/gorilla/websocket/issues/432))
* Transparent message buffer reuse with [wsjson](https://pkg.go.dev/github.com/seanpfeifer/websocket/wsjson) and [wspb](https://pkg.go.dev/github.com/seanpfeifer/websocket/wspb) subpackages
...
* [CloseRead](https://pkg.go.dev/github.com/seanpfeifer/websocket#Conn.CloseRead) helper ([gorilla/websocket#492](https://github.com/gorilla/websocket/issues/492))
...
The [net.Conn](https://pkg.go.dev/github.com/seanpfeifer/websocket#NetConn) can help in transitioning
to github.com/seanpfeifer/websocket.
